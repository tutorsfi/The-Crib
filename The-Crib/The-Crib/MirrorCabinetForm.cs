...
namespace The_Crib
{
    public partial class MirrorCabinetForm : Form
    {

        readonly DictionaryMirrorCabinet look = new DictionaryMirrorCabinet();

        public MirrorCabinetForm()
        {
            InitializeComponent();
        }
        ...
        private void MirrorCabinetForm_Load(object sender, EventArgs e)
        {
        ...
        private void MirrorCabinetImgPB(object sender, EventArgs e)
        {
